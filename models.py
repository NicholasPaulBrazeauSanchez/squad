...
class RNET(nn.Module):
    ...
    def forward(self, cw_idxs, qw_idxs, cc_idxs, qc_idxs):
        ...
        c_emb = self.emb(cw_idxs, cc_idxs, cc_mask)         # (batch_size, c_len, 2* hidden_size)
        q_emb = self.emb(qw_idxs, qc_idxs, qc_mask)         # (batch_size, q_len, 2* hidden_size)
...
class SelfAttChar(nn.Module):
    def __init__(self, word_vectors, char_vectors, hidden_size, drop_prob=0.):
        super(SelfAttChar, self).__init__()
        self.emb = layers.EmbeddingWithChar(word_vectors=word_vectors,
                                            char_vectors=char_vectors,
                                    hidden_size=hidden_size,
                                    drop_prob=drop_prob)
...
class RNNOutputSelfAttention(nn.Module):
    """Baseline BiDAF model for SQuAD.
    ...
    """
    def __init__(self, word_vectors, hidden_size, drop_prob=0.):
        super(RNNOutputSelfAttention, self).__init__()
        self.emb = layers.Embedding(word_vectors=word_vectors,
                                    hidden_size=hidden_size,
                                    drop_prob=drop_prob)
        ...
        self.out = layers.BiDAFOutputRnn(hidden_size, drop_prob)
    ...
    def forward(self, cw_idxs, qw_idxs):
        ...
        out = self.out(att, q_enc, q_mask, h, c_mask)

        return out
    

    
class BiDAFCharRNNOutput(nn.Module):
    """Baseline BiDAF model for SQuAD.
    Based on the paper:
    "Bidirectional Attention Flow for Machine Comprehension"
    by Minjoon Seo, Aniruddha Kembhavi, Ali Farhadi, Hannaneh Hajishirzi
    ...
    """
    def __init__(self, word_vectors, char_vectors, hidden_size, drop_prob=0.):
        super(BiDAFCharRNNOutput, self).__init__()
        self.emb = layers.EmbeddingWithChar(word_vectors=word_vectors,
                                            char_vectors=char_vectors,
                                    hidden_size=hidden_size,
                                    drop_prob=drop_prob)
        ...
        self.out = layers.BiDAFOutputRnnMulti(hidden_size=hidden_size,
                                      drop_prob=drop_prob)
...
class BiDAFCharRNNOutputCoatt(nn.Module):
    ...
    """
    def __init__(self, word_vectors, char_vectors, hidden_size, drop_prob=0.):
        super(BiDAFCharRNNOutputCoatt, self).__init__()
        self.emb = layers.EmbeddingWithChar(word_vectors=word_vectors,
                                            char_vectors=char_vectors,
                                    hidden_size=hidden_size,
                                    drop_prob=drop_prob)
        ...
        self.att = layers.CoAttention(hidden_size=2 * hidden_size, drop_prob=drop_prob)
...
class SelfAttention(nn.Module):
    ...
    def forward(self, cw_idxs, qw_idxs):
        ...
        out = self.out(att, q_enc, q_mask, h, c_mask)  # 2 tensors, each (batch_size, c_len)
